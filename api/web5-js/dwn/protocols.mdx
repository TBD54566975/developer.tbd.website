                                                    ...
                                                    value: <ApiDetails
                                                            ...
                                                            },
                                                            {
                                                                data: {
                                                                    ...
                                                                    type: 'string',
                                                                    field: 'dataFormat',
                                                                    value: 'The IANA string corresponding with the format of the data the records will be bucketed. See IANA\'s Media Type list here: https://www.iana.org/assignments/media-types/media-types.xhtml',
                                                                },
                                                            },                              
                                                        ]}
                                                      />,
