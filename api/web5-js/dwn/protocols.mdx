                                                    ...
                                                    value: <ApiDetails
                                                            ...
                                                            },
                                                            {
                                                                data: {
                                                                    ...
                                                                    type: 'string[]',
                                                                    field: 'dataFormats',
                                                                    value: 'Array of the IANA string corresponding with the formats of how the data will be bucketed. See IANA\'s Media Type list here: https://www.iana.org/assignments/media-types/media-types.xhtml',
                                                                },
                                                            },                              
                                                        ]}
                                                      />,
