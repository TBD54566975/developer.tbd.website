...
Every modifying method of the `records` class returns an instance of a [Record](record.mdx) object, which is a representation of the record involved in the operation
