...
```js
<script src="https://unpkg.com/@tbd54566975/web5@0.7.5/dist/browser.js"></script>
```

or

```js
<script src="https://cdn.jsdelivr.net/npm/@tbd54566975/web5@0.7.5/dist/browser.mjs"></script>
```
...
```js
import { Web5 } from "https://unpkg.com/@tbd54566975/web5@0.7.5/dist/browser.js";
```
