...
git checkout tags/0.3.0 -b incubating-web5-labs-todo-app
cd todo-app
npm install
npm run dev
```
...
Congratulations, you've just built a decentralized web app! Feel free to check out the [finished version of the ToDo app here](https://github.com/TBD54566975/incubating-web5-labs/tree/0.2.0/todo-app) or see it deployed [here](https://unrivaled-crumble-56ce70.netlify.app/).
