...
Congratulations, you've just built a decentralized web app! Feel free to check out the [finished version of the project here](https://github.com/TBD54566975/incubating-web5-labs/tree/main/todo-app).
