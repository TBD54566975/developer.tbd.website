...
<head>
  <title>Self-sovereign Identity SDK | TBD</title>
  <meta property="og:title" content="Self-sovereign Identity SDK | TBD" />
  ...
  <meta
    property="og:url"
    content="https://developer.tbd.website/projects/ssi-sdk/README"
  />
  <link
...
<div className="mb-18"><ButtonGroup buttons={[{"type":"button","data":{"label":"Source on GitHub","url":"https://github.com/TBD54566975/ssi-sdk","isExternalLink":true,"imageURL":"/img/external-link-blue-icon.svg"}},{"type":"button","data":{"label":"Issues","url":"https://github.com/TBD54566975/ssi-sdk/issues","isExternalLink":true,"imageURL":"/img/external-link-blue-icon.svg"}}]} /></div>
