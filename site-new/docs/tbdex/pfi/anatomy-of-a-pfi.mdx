...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>/exchanges/:id</td>
      <td>
        Used to add additional messages (e.g. `Order`, `Close`) to an existing
        exchange
      </td>
    </tr>
    <tr>
      ...
      <td>/exchanges</td>
      <td>
        Used to get the exchange IDs of all exchanges that match a specified
        filter
      </td>
    </tr>
    <tr>
...
<Shnip languages={["JavaScript", "Kotlin"]} snippetName="pfiOverviewConfig" />
...
<Shnip
  ...
  snippetName={"pfiOverviewServerRoutes"}
/>
...
<Shnip
  languages={["JavaScript", "Kotlin"]}
  snippetName="pfiOverViewServerStart"
/>
...
// The `Offerings` API is the set of methods that deals with reading and writing any offering data, based on the ADD LANGUAGE SWITCH LINK HERE class.
...
<Shnip
  languages={["JavaScript", "Kotlin"]}
  snippetName="pfiOverviewReadOfferings"
/>
...
<Shnip languages={["JavaScript", "Kotlin"]} snippetName="pfiOverviewWrite" />
