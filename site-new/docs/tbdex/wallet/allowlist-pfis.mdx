...
To determine if a PFI is part of the tbDEX network, you can check their [DID document](/docs/web5/decentralized-identifiers/did_documents) for the `PFI` service type:

<Shnip languages={["JavaScript", "Kotlin", "Swift"]} snippetName="isPFI" />
