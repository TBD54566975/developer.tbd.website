...
<Shnip
  ...
  snippetName="retrievePresentationDefinitionFromOfferingsRequiredClaims"
/>
...
<Shnip
  languages={["JavaScript", "Kotlin", "Swift"]}
  snippetName="findMatchingOfferingsWithCredentialValidation"
/>
...
<Shnip
  languages={["JavaScript", "Kotlin", "Swift"]}
  snippetName="getSelectedCredentials"
/>
