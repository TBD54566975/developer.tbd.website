...
<div className="grid grid-cols-1 desktop:grid-cols-1">
  <iframe class="aspect-video" src="https://www.youtube.com/embed/KiJH2pgwh5U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
As intermediaries, Wallets often manage [Decentralized Identifiers (DIDs)](/docs/web5/decentralized-identifiers/what-are-dids) and [Verifiable Credentials (VCs)](/docs/web5/verifiable-credentials/what-are-vcs) on behalf of their users.
...
6. [Create a DID for customer](/docs/web5/decentralized-identifiers/how-to-create-did/)
