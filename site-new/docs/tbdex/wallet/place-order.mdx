...
<Shnip languages={["JavaScript", "Kotlin", "Swift"]} snippetName="signOrder" />

## Send Order

After creating and signing the Order, it needs to be sent to the PFI via the following:

<Shnip languages={["JavaScript", "Kotlin", "Swift"]} snippetName="sendOrder" />
...
<Shnip
  languages={["JavaScript", "Kotlin", "Swift"]}
  snippetName="listenForOrderStatus"
/>
