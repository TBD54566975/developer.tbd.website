...
After [sending an RFQ](/docs/tbdex/wallet/send-rfq#send-rfq-to-pfi), the PFI will respond with an exact **Quote** for your customer. This message will be written to the exchange.
