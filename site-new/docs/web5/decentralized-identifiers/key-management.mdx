...
<LanguageContent language="Kotlin">
  <p>
    Any of these can be used by implementing the
    [KeyManager](https://tbd54566975.github.io/web5-kt/docs/-web5%20-s-d-k%20-documentation/web5.sdk.crypto/-key-manager/index.html)
    interface.
  </p>
</LanguageContent>
...
<Dependencies
  languageDependencies={[
    {
      language: "javascript",
      dependencies: ["@web5/dids", "@web5/crypto", "@web5/crypto-aws-kms"],
    },
    {
      language: "maven",
      dependencies: ["web5-dids", "web5-crypto", "web5-keymanager-aws"],
    },
    {
      language: "gradle",
      dependencies: ["web5-dids", "web5-crypto", "web5-keymanager-aws"],
...
<Shnip
  snippetName="importKeyManagement"
...
<Shnip
  snippetName="initializeKeyManagement"
  languages={["JavaScript", "Kotlin", "Swift"]}
/>
...
<LanguageContent language="Kotlin">
  <p>
    ...
    Guide](https://tbd54566975.github.io/web5-kt/docs/-web5%20-s-d-k%20-documentation/web5.sdk.crypto/-aws-key-manager/index.html)
    for information on how to use the KMSClient instance from the AWS SDK to
    store the private keys to your DID.
  </p>
</LanguageContent>
