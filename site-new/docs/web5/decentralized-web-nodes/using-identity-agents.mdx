...
<Shnip functionName="createIdentityAgent" languages={["JavaScript"]} />
...
<Shnip functionName="authenticateIdentityAgent" />
...
<Shnip functionName="getDwnEndpoints" />
...
<Shnip
  functionName="createSocialMediaAndCareerIdentity"
...
<Shnip functionName="connectIdentityToWeb5" languages={["JavaScript"]} />
