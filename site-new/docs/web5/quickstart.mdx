...
<ul>
  <li>
    <p>
      ...
      , <code>npm</code>, installed and on your system's <code>$PATH</code>.
    </p>
  </li>
  <li>
...
<p>
  This will be the home of your new Web5 app. Run the following commands in your
  CLI:{" "}
</p>{" "}
...
<Dependency
  language={"javascript"}
  dependencies={["@web5/api", "@web5/credentials"]}
/>
...
<Shnip functionName="didCreate" languages={["JavaScript"]} />
...
<QuickstartCodeRunner
  executeCodeName="executeDidCreate"
  stepIndex={0}
  autoOpenDetails={false}
  customPlaceholder={"Your DID will appear here"}
/>
...
<Shnip snippets={[{ snippetName: "getBearerDid", language: "JavaScript" }]} />
...
<QuickstartCodeRunner
  executeCodeName="executeGetBearerDid"
  stepIndex={1}
  viewJsonObj={true}
  collapseLevel={1}
  customPlaceholder={"Your Bearer DID will appear here"}
/>
...
<Shnip
  snippets={[{ snippetName: "createQuickstartVc", language: "JavaScript" }]}
/>
...
<QuickstartCodeRunner
  executeCodeName="executeCreateVc"
  stepIndex={2}
  viewJsonObj={true}
  defaultInputValue="Alice Smith"
  customPlaceholder={"Your VC will appear here"}
/>
...
<Shnip
  snippets={[{ snippetName: "signQuickstartVc", language: "JavaScript" }]}
/>
...
<QuickstartCodeRunner
  executeCodeName="executeSignVc"
  stepIndex={3}
  customPlaceholder={"Your JWT will appear here"}
/>
...
<Shnip
  snippets={[{ snippetName: "writeQuickstartVcToDwn", language: "JavaScript" }]}
/>
...
<QuickstartCodeRunner
  executeCodeName="executeWriteVcToDwn"
  stepIndex={4}
  viewJsonObj={true}
  collapseLevel={1}
  customPlaceholder={"Your written result will appear here"}
/>
...
<Shnip
  snippets={[{ snippetName: "readQuickstartVc", language: "JavaScript" }]}
/>
...
<QuickstartCodeRunner
  executeCodeName="executeReadVcFromDwn"
  stepIndex={5}
  customPlaceholder={"Your read result will appear here"}
/>
...
<Shnip
  snippets={[{ snippetName: "parseQuickstartVc", language: "JavaScript" }]}
/>
...
<QuickstartCodeRunner
  executeCodeName="executeParseVc"
  stepIndex={6}
  viewJsonObj={true}
  customPlaceholder={"Your parsed VC will appear here"}
/>
