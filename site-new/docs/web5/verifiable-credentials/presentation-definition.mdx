...
- [format](https://identity.foundation/presentation-exchange/spec/v1.0.0/#claim-format-designations): The optional technical format requirements for the data to be submitted. _Example: \{ "jwt_vc": \{"alg": ["ES256K", "ES384"]} }_
...
1. import classes needed for a Presentation Exchang
   e
