...
<Shnip
  snippetName="createStatusListCredential"
...
<Shnip
  snippetName="createRevocableVerifiableCredential"
  languages={["JavaScript", "Kotlin"]}
/>
...
<Shnip snippetName="revokeCredential" languages={["JavaScript", "Kotlin"]} />
...
<Shnip
  snippetName="checkIfCredentialIsRevoked"
  languages={["JavaScript", "Kotlin"]}
/>
