...
<Shnip snippetName="verifyVcs" languages={["JavaScript", "Kotlin"]} />
...
<Shnip snippetName="errorsFound" languages={["JavaScript", "Kotlin"]} />
...
<Shnip snippetName="verifyVpJs" languages={["JavaScript", "Kotlin"]} />
...
<Shnip snippetName="evaluatePresentation" languages={["JavaScript"]} />

<CodeBlock language="kotlin">
  This functionality does not exist in the Kotlin SDK.
</CodeBlock>
