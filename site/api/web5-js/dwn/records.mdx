                        ...
                        value: <ApiDetails
                                ...
                                },
                                {
                                    data: {
                                        ...
                                        isOptional: true,
                                        field: 'datePublished',
                                        value: 'The date the record was published. When specifying to publish a record without providing the datePublished attribute, the record will be published now',
                                    },
                                },                                                                                                                            
                            ]}
                        />,
...
```js
// this creates a published record
const { record } = await web5.dwn.records.create({
