                                        ...
                                        value: <ApiDetails
                                                details={[
                                                {
                                                    data: {
                                                        type: 'string',
                                                        isOptional: true,
                                                        field: 'createdAscending',
                                                        value: 'Sorting records by dateCreated in ascending order',
                                                    },
                                                },  
                                                {
                                                    data: {
                                                        type: 'string',
                                                        isOptional: true,
                                                        field: 'createdDescending',
                                                        value: 'Sorting records by dateCreated in descending order',
                                                    },
                                                }, 
                                                {
                                                    data: {
                                                        type: 'string',
                                                        isOptional: true,
                                                        field: 'publishedAscending',
                                                        value: 'Sorting records by datePublished in ascending order',
                                                    },
                                                }, 
                                                {
                                                    data: {
                                                        type: 'string',
                                                        isOptional: true,
                                                        field: 'publishedDescending',
                                                        value: 'Sorting records by datePublished in descending order',
                                                    },
                                                },                                                                                                                            
                                            ]}
                                        />,
