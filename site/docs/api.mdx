...
<div>
  <div className="grid grid-cols-1 desktop:grid-cols-2 gap-4 pt-6">
    ...
    />
    <ApiCard
      url="https://tbd54566975.github.io/tbdex-js/index.html"
      name="tbDEX JS SDK"
      description="A library to build financial applications that facilitate the smooth transfer of currencies across borders."
    />
    <ApiCard
