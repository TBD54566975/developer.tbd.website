...
<ReusableTabs
MacCommand = {`curl -X PUT -d '{"keyType":"Ed25519"}' localhost:8080/v1/dids/key`}
WinCommand = {`curl -X PUT -d "{"keyType":"Ed25519"}" localhost:8080/v1/dids/key`}
 />
...
<ReusableTabs
MacCommand = {`curl -X PUT localhost:8080/v1/dids/ion -d '{"keyType":"Ed25519"}'`}
WinCommand = {`curl -X PUT localhost:8080/v1/dids/ion -d "{"keyType":"Ed25519"}"`}
 />
...
<ReusableTabs
MacCommand={`curl -X PUT 'localhost:3000/v1/dids/web' -d '{
  "keyType": "Ed25519",
  "options": {
    "didWebId": "did:web:example.com"
  }
}`}
WinCommand={`curl -X PUT 'localhost:3000/v1/dids/web' -d "{
  "keyType": "Ed25519",
  "options": {
    "didWebId": "did:web:example.com"
  }
