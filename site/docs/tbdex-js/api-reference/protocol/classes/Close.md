...
- [validNext](Close.md#validnext)
- [factory](Close.md#factory)

### Accessors

- [createdAt](Close.md#createdat)
- [data](Close.md#data)
- [exchangeId](Close.md#exchangeid)
- [from](Close.md#from)
- [id](Close.md#id)
- [kind](Close.md#kind)
- [metadata](Close.md#metadata)
- [reason](Close.md#reason)
- [signature](Close.md#signature)
- [to](Close.md#to)

### Methods

- [isClose](Close.md#isclose)
- [isOrder](Close.md#isorder)
- [isOrderStatus](Close.md#isorderstatus)
- [isQuote](Close.md#isquote)
- [isRfq](Close.md#isrfq)
- [sign](Close.md#sign)
- [toJSON](Close.md#tojson)
- [verify](Close.md#verify)
- [create](Close.md#create)
- [fromJson](Close.md#fromjson)
- [generateId](Close.md#generateid)
- [parse](Close.md#parse)
- [validate](Close.md#validate)
- [verify](Close.md#verify-1)

## Constructors

### constructor

• **new Close**(`jsonMessage`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `jsonMessage` | [`NewMessage`](../index.md#newmessage)<``"close"``\> |
...
[`MessageModel`](../index.md#messagemodel)<``"close"``\>
