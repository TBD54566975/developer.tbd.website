[@tbdex/protocol](../index.md) / OrderStatus
...
- [constructor](OrderStatus.md#constructor)

### Properties

- [validNext](OrderStatus.md#validnext)
- [factory](OrderStatus.md#factory)

### Accessors

- [createdAt](OrderStatus.md#createdat)
- [data](OrderStatus.md#data)
- [exchangeId](OrderStatus.md#exchangeid)
- [from](OrderStatus.md#from)
- [id](OrderStatus.md#id)
- [kind](OrderStatus.md#kind)
- [metadata](OrderStatus.md#metadata)
- [orderStatus](OrderStatus.md#orderstatus)
- [signature](OrderStatus.md#signature)
- [to](OrderStatus.md#to)

### Methods

- [isClose](OrderStatus.md#isclose)
- [isOrder](OrderStatus.md#isorder)
- [isOrderStatus](OrderStatus.md#isorderstatus)
- [isQuote](OrderStatus.md#isquote)
- [isRfq](OrderStatus.md#isrfq)
- [sign](OrderStatus.md#sign)
- [toJSON](OrderStatus.md#tojson)
- [verify](OrderStatus.md#verify)
- [create](OrderStatus.md#create)
- [fromJson](OrderStatus.md#fromjson)
- [generateId](OrderStatus.md#generateid)
- [parse](OrderStatus.md#parse)
- [validate](OrderStatus.md#validate)
- [verify](OrderStatus.md#verify-1)
