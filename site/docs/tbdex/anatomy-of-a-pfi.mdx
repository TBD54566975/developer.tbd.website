...
The Exchanges API is the set of methods that deals with reading and writing any messages data, based on the [`ExchangesApi`](https://developer.tbd.website/docs/tbdex/api-reference/tbdex-js/http-server/interfaces/ExchangesApi) class. Although the interface for `ExchangesApi` only requires to be filled out with read operations, you may find it useful to couple write operations into the class as well. 
...
After writing an RFQ to the database, you’ll then want to [create a Quote](docs/tbdex/creating-quotes). Similarly, after writing an Order to your database, you’ll want to ensure you properly [process that Order](docs/tbdex/processing-orders).


### Offerings API Provider

The Offerings API is the set of methods that deals with reading and writing any offering data, based on the [OfferingsApi](https://developer.tbd.website/docs/tbdex/api-reference/tbdex-js/http-server/interfaces/OfferingsApi) class. Although the interface for `OfferingsApi` only requires to be filled out with read operations, you may find it useful to couple write operations into the class as well. 
