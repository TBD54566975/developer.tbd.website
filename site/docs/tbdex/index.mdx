...
tbDEX is architected on Web5 infrastructure, utilizing decentralized technologies such as [Decentralized Identifiers](/docs/web5/learn/decentralized-identifiers) (DIDs) and [Verifiable Credentials](/docs/web5/learn/verifiable-credentials) (VCs).
