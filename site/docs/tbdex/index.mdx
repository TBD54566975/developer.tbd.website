...
* [Decentralized Web Notes](/docs/web5/learn/decentralized-web-nodes) (DWNs)
...
Using the tbDEX protocol, PFIs and wallet holders - both identified by unique DIDs - can exchange messages. These messages, which are used to negotiate exchanges, may be stored in DWNs for scenarios that require self-custody.
