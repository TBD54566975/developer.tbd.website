...
tbDEX is architected on Web5 infrastructure, utilizing decentralized technologies such as [Decentralized Identifiers (DIDs)](/docs/web5/learn/decentralized-identifiers) and [Verifiable Credentials (VCs)](/docs/web5/learn/verifiable-credentials).
