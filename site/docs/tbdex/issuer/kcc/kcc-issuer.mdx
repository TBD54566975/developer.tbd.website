...
5. Configure the `/.well-known/openid-credential-issuer` endpoint that will return your Issuer Metadata:
...
6. Configure the `/.well-known/oauth-authorization-server` endpoint that will return your Issuer Authorization Server Metadata:
