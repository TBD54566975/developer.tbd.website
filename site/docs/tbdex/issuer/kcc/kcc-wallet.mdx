...
For a hands-on example of the complete flow for requesting and issuing a KCC, check out the [Known Customer Credential Exemplar](https://github.com/TBD54566975/kcc-prototype-exemplar) on GitHub. This exemplar provides a practical implementation of requesting and issuing a Known Customer Credential (KCC).
