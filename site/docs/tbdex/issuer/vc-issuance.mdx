...
import checkSanctionsListsFunction from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/issuer/checkSanctionsListsFunction.snippet.js';
...
import sanctionsCredentialClassKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/issuer/sanctionsCredentialClassKt.snippet.kt';
import checkSanctionsEndpointKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/issuer/checkSanctionsEndpointKt.snippet.kt';
import createVerifiableCredentialWithSanctionsListResultKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/issuer/createVerifiableCredentialWithSanctionsListResultKt.snippet.kt';
import signCreatedSanctionsCredentialKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/issuer/signCreatedSanctionsCredentialKt.snippet.kt';
import checkSanctionsListsFunctionAndSanctionsListResultClassKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/issuer/checkSanctionsListsFunctionAndSanctionsListResultClassKt.snippet.kt';
...
<Shnip
  snippets={[
    ...
    {
      snippetContent: sanctionsCredentialClassKt,
      language: 'Kotlin',
...
<Shnip
  snippets={[
    ...
    {
      snippetContent: checkSanctionsEndpointKt,
      language: 'Kotlin',
      title: 'Application.kt',
    },
  ]}
...
<Shnip
  snippets={[
    {
      snippetContent: checkSanctionsListsFunction,
      language: 'JavaScript',
      title: 'api.js',
    },
    {
      snippetContent: checkSanctionsListsFunctionAndSanctionsListResultClassKt,
      language: 'Kotlin',
      title: 'Application.kt',
    },
  ]}
...
The `/check-sanctions` endpoint should handle the results of the sanction check and create a Verifiable Credential:
...
<Shnip
  snippets={[
    ...
    {
      snippetContent: createVerifiableCredentialWithSanctionsListResultKt,
      language: 'Kotlin',
      title: 'Application.kt',
    },
  ]}
...
:::note
The BearerDid is used to sign Verifiable Credentials that you issue. Refer to the [Create A DID](/docs/web5/build/decentralized-identifiers/how-to-create-did) guide for steps on how to create one.
:::
...
<Shnip
  snippets={[
    ...
    {
      snippetContent: signCreatedSanctionsCredentialKt,
      language: 'Kotlin',
      title: 'Application.kt',
    },
  ]}
