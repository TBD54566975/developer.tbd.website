...
import checkSacntionsListsFunctionKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/issuer/checkSacntionsListsFunctionKt.snippet.kt';
...
import checkSacntionsListsFunctionAndSanctionsListResultClassKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/issuer/checkSacntionsListsFunctionAndSanctionsListResultClassKt.snippet.kt';
...
<Shnip
  snippets={[
    ...
    {
      snippetContent: checkSacntionsListsFunctionAndSanctionsListResultClassKt,
      language: 'Kotlin',
      title: 'Application.kt',
    },
  ]}
