...
If you don't already have one, you'll need to [create a DID](/docs/web5/build/decentralized-identifiers/how-to-create-did) with an IDV (Identity Verification) service endpoint:
...
- [Known Customer Credential Guide](/docs/tbdex/issuer/kcc/kcc-issuer)
