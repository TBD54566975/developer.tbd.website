...
<PfiQuickstartCodeRunner executeCodeName="executeGetOfferings" stepIndex={2} customPlaceholder={"Fetch offerings from the PFI Endpoint"} viewJsonObj={true} collapseLevel={3} />
...
<PfiQuickstartCodeRunner executeCodeName="executeGetQuote" stepIndex={3} customPlaceholder={"See the Quote"} viewJsonObj={true} collapseLevel={1} />
...
<PfiQuickstartCodeRunner executeCodeName="executeGetOrderStatus" stepIndex={4} customPlaceholder={"See the OrderStatus"} viewJsonObj={true} collapseLevel={1} />
...
<PfiQuickstartCodeRunner executeCodeName="executeGetClose" stepIndex={5} customPlaceholder={"See the Close Message"} viewJsonObj={true} collapseLevel={1} />
