...
import configJs from '!!raw-loader!@site/snippets/tbdex/pfi/pfiOverviewConfigJs.snippet.js'
import configKt from '!!raw-loader!@site/snippets/tbdex/pfi/pfiOverviewConfigKt.snippet.kt'
...
import writeJs from '!!raw-loader!@site/snippets/tbdex/pfi/pfiOverviewWriteJs.snippet.js'
import writeKt from '!!raw-loader!@site/snippets/tbdex/pfi/pfiOverviewWriteKt.snippet.kt'
...
<Shnip snippets={
  [
    { snippetContent: configJs, language: 'JavaScript'},
    { snippetContent: configKt, language: 'Kotlin'}
  ]} />
...
<Shnip snippets={
  [
    { snippetContent: writeJs, language: 'JavaScript'},
    { snippetContent: writeKt, language: 'Kotlin'}
  ]} />
