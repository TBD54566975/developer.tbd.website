...
Here is a list of the reequired routes you'll need to implement:
...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      <td>PUT</td>
      <td>/exchanges/:id</td>
      <td>Used to add additional messages to a pre-existing exchange e.g. order or close</td>
    </tr>
    <tr>
      <td>GET</td>
      <td>/exchanges</td>
      <td>Used to get exchanges</td>
    </tr>
    <tr>
      <td>GET</td>
      <td> /exchanges/:id</td>
