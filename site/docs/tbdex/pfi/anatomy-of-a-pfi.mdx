...
The `Offerings` API is the set of methods that deals with reading and writing any offering data, based on the <LanguageSwitchLink text="OfferingsApi" links='{"JavaScript": "https://tbd54566975.github.io/tbdex-js/interfaces/_tbdex_http_server.OfferingsApi.html", "Kotlin": "https://tbd54566975.github.io/tbdex-kt/httpserver/tbdex.sdk.httpserver.models/-offerings-api/index.html?query=interface%20OfferingsApi"}'/> class. 
