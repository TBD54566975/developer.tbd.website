...
<Shnip snippets={
  [
    ...
    { snippetName: 'pfiQuotesWriteKt', language: 'Kotlin'}
  ]} />
...
<Shnip snippets={
  [
    ...
    { snippetName: 'pfiQuotesProcessKt', language: 'Kotlin'}
  ]} />
...
<Shnip snippets={
  [
    ...
    { snippetName: 'pfiQuotesSendKt', language: 'Kotlin'}
  ]} />
...
<Shnip snippets={
  [
    ...
    { snippetName: 'pfiQuotesSignKt', language: 'Kotlin'}
  ]} />
