...
import pfiCreateOfferingKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/pfi/pfiCreateOfferingKt.snippet.kt'
...
<Shnip snippets={
  [
    ...
    { snippetContent: pfiCreateOfferingKt, language: 'Kotlin'}
  ]} />
