...
import pfiCreateOfferingJs from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/pfi/pfiCreateOfferingJs.snippet.js'
...
<Shnip snippets={
  [
    { snippetContent: pfiCreateOfferingJs, language: 'JavaScript'},
