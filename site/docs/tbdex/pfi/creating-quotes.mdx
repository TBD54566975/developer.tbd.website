...
<Shnip snippets={
  [
    { snippetName: 'pfiQuotesWriteJs', language: 'JavaScript'},
...
<Shnip snippets={
  [
    { snippetName: 'pfiQuotesProcessJs', language: 'JavaScript'},
...
<Shnip snippets={
  [
    { snippetName: 'pfiQuotesSendJs', language: 'JavaScript'},
...
<Shnip snippets={
  [
    { snippetName: 'pfiQuotesSignJs', language: 'JavaScript'},
