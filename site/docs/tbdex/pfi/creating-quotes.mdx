...
import pfiWriteRfqGetOfferingKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/pfi/pfiWriteRfqGetOfferingKt.snippet.kt'
...
import pfiRfqVerifyOfferingRequirementsKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/pfi/pfiRfqVerifyOfferingRequirementsKt.snippet.kt'
import pfiQuotesSendJs from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/pfi/pfiQuotesSendJs.snippet.js'
import pfiCreateQuoteKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/pfi/pfiCreateQuoteKt.snippet.kt'
import pfiQuotesSignJs from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/pfi/pfiQuotesSignJs.snippet.js'
import pfiSignQuoteKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/pfi/pfiSignQuoteKt.snippet.kt'
...
<Shnip snippets={
  [
    ...
    { snippetContent: pfiWriteRfqGetOfferingKt, language: 'Kotlin'}
  ]} />
...
<Shnip snippets={
  [
    ...
    { snippetContent: pfiRfqVerifyOfferingRequirementsKt, language: 'Kotlin'}
  ]} />
...
<Shnip snippets={
  [
    ...
    { snippetContent: pfiCreateQuoteKt, language: 'Kotlin'}
  ]} />
...
<Shnip snippets={
  [
    ...
    { snippetContent: pfiSignQuoteKt, language: 'Kotlin'}
  ]} />
