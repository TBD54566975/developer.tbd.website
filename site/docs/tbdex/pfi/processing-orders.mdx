...
import pfiOrdersJs from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/pfi/pfiOrdersStatusJs.snippet.js'
import pfiOrdersKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/pfi/pfiOrdersStatusKt.snippet.kt'
...
<Shnip snippets={
  [
    { snippetContent: pfiOrdersJs, language: 'JavaScript'},
    { snippetContent: pfiOrdersKt, language: 'Kotlin'}
  ]} />
