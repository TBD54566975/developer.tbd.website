...
VCs are stored as JWTs - in this case we're assuming that they have been fetched from local storage and placed into a string array called `myCredentials` -, and once you've saved the token above you can access and filter through them like so:
