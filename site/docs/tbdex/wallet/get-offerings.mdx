...
import walletGetOfferingsJS from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/wallet/walletGetOfferingsJS.snippet.js'
import walletGetOfferingsKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/wallet/walletGetOfferingsKt.snippet.kt'
import walletFindMatchingOfferingsJS from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/wallet/walletFindMatchingOfferingsJS.snippet.js'
import walletFindMatchingOfferingsKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/wallet/walletFindMatchingOfferingsKt.snippet.kt'
...
<Shnip
  snippets={[
    { snippetContent: walletGetOfferingsJS, language: 'JavaScript' },
    { snippetContent: walletGetOfferingsKt, language: 'Kotlin' },
  ]}
/>
...
<Shnip
  snippets={[
    { snippetContent: walletFindMatchingOfferingsJS, language: 'JavaScript' },
    { snippetContent: walletFindMatchingOfferingsKt, language: 'Kotlin' },
  ]}
/>
