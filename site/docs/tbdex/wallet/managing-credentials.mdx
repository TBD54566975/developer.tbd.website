...
Customer credentials are tied to their [DID](/docs/web5/decentralized-identifiers/what-are-dids). Wallets will have to [create a DID](/docs/web5/decentralized-identifiers/how-to-create-did) for customers that don't have one yet.
:::
