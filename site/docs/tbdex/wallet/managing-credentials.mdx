...
import findMatchingOfferingsWithCredentialValidationKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/wallet/findMatchingOfferingsWithCredentialValidationKt.snippet.kt';
import findMatchingOfferingsWithCredentialValidationJS from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/wallet/findMatchingOfferingsWithCredentialValidationJS.snippet.js';

import retrievePresentationDefinitionFromOfferingsRequiredClaimsJS from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/wallet/retrievePresentationDefinitionFromOfferingsRequiredClaimsJS.snippet.js';
import retrievePresentationDefinitionFromOfferingsRequiredClaimsKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/wallet/retrievePresentationDefinitionFromOfferingsRequiredClaimsKt.snippet.kt';

import getSelectedCredentialsKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/wallet/getSelectedCredentialsKt.snippet.kt';
import getSelectedCredentialsJS from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/wallet/getSelectedCredentialsJS.snippet.js';
...
<Shnip
  snippets={[
    {
      snippetContent:
        retrievePresentationDefinitionFromOfferingsRequiredClaimsKt,
      language: 'Kotlin',
    },
    {
      snippetContent:
        retrievePresentationDefinitionFromOfferingsRequiredClaimsJS,
      language: 'JavaScript',
    },
  ]}
/>
...
<Shnip
  snippets={[
    {
      snippetContent: findMatchingOfferingsWithCredentialValidationKt,
      language: 'Kotlin',
    },
    {
      snippetContent: findMatchingOfferingsWithCredentialValidationJS,
      language: 'JavaScript',
    },
  ]}
/>
...
<Shnip
  snippets={[
    {
      snippetContent: getSelectedCredentialsKt,
      language: 'Kotlin',
    },
    {
      snippetContent: getSelectedCredentialsJS,
      language: 'JavaScript',
    },
  ]}
/>
