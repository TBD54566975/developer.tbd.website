...
Within a tbDEX network, [Verifiable Credentials (VC)](/docs/web5/verifiable-credentials/what-are-vcs) play a critical role in establishing trust and ensuring regulatory compliance during transactions.
...
Learn how to request a [Known Customer Credential](/docs/tbdex/issuer/kcc/kcc-wallet) that your customers can use with PFIs.
:::
...
Customer credentials are tied to their [Decentralized Identifier (DID)](/docs/web5/decentralized-identifiers/what-are-dids). Wallets will have to [create a did](/docs/web5/decentralized-identifiers/how-to-create-did) for customers that don't have one yet.
:::
...
<Shnip
  snippets={[
    ...
    {
      snippetName: 'retrievePresentationDefinitionFromOfferingsRequiredClaimsSwift',
      language: 'Swift',
    },
  ]}
/>
...
<Shnip
  snippets={[
    ...
    {
      snippetName: 'findMatchingOfferingsWithCredentialValidationSwift',
      language: 'Swift',
    },
  ]}
/>
...
Your application could even apply for certain credentials on behalf of the customer, or [issue credentials](/docs/web5/verifiable-credentials/vc-issuance) that you have the credibility to do so.
...
<Shnip
  snippets={[
    ...
    {
      snippetName: 'getSelectedCredentialsSwift',
      language: 'Swift',
    },
  ]}
/>
