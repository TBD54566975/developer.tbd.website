...
import findMatchingOfferingsKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/tbdex/wallet/findMatchingOfferingsKt.snippet.kt';
import findMatchingOfferingsJS from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/tbdex/wallet/findMatchingOfferingsJS.snippet.js';
...
<Shnip
  inlineSnippets={[
    {
      code: `const presentationDefinition = offering.data.requiredClaims;`,
      language: 'JavaScript',
    },
    {
      code: `val presentationDefinition = offering.data.requiredClaims`,
      language: 'Kotlin',
    },
  ]}
/>
...
<Shnip
  snippets={[
    {
      snippetContent: findMatchingOfferingsKt,
      language: 'Kotlin',
    },
    {
      snippetContent: findMatchingOfferingsJS,
      language: 'JavaScript',
    },
  ]}
/>
