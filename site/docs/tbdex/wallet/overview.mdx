...
<div className="grid grid-cols-1 desktop:grid-cols-1">
  <iframe className="aspect-video" src="https://www.youtube.com/embed/KiJH2pgwh5U" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
</div>
