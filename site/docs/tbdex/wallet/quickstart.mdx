...
<WalletQuickstartCodeRunner executeCodeName="executeGetOfferings" stepIndex={0} autoOpenDetails={false} customPlaceholder={"See the PFI's Offerings"} viewJsonObj={true} collapseLevel={1}/>
...
<WalletQuickstartCodeRunner executeCodeName="executeProcessQuote" stepIndex={3} customPlaceholder={"View Quote"}/> 
...
<WalletQuickstartCodeRunner executeCodeName="executeCreateOrder" stepIndex={4} customPlaceholder={"Create your order"}/> 
...
<WalletQuickstartCodeRunner executeCodeName="executeProcessClose" stepIndex={5} customPlaceholder={"View your close reason"}/> 
