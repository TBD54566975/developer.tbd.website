...
Now that you've received a Quote, you can present it to your user and give them the option to [place an Order](/docs/tbdex/wallet/place-order/) or cancel the exchange.
