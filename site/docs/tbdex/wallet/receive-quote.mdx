...
To terminate the exchange, create a `Close` message, sign it with the customer's [Bearer DID](/docs/web5/decentralized-identifiers/how-to-create-did#create-did), and send the message.
