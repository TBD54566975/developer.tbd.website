...
## Sign the RFQ
Signing the RFQ ensures its authenticity. You can do so with the customer's [Bearer DID](/docs/web5/decentralized-identifiers/how-to-create-did#create-did):
