...
* **payin** - How the customer intends to pay the PFI
  ...
  * **paymentDetails** - The exact details of the payment method. As this information is senstive, the SDK will convert these details into [salted hashes](https://github.com/TBD54566975/tbdex/tree/main/specs/protocol#privatedata-1)
