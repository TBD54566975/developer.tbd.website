...
<details>
<summary>Additional steps for React Native or Node 18</summary>
<p>
...
<p>Node.js 18 or earlier needs globalThis.crypto polyfill:</p>
```js
...
<p>React Native:</p>
<p>Needs crypto.getRandomValues polyfill and sha512</p>
```js
