...
### 📘 Learn more
Learn more about [defining protocols](https://developer.tbd.website/docs/web5/decentralized-web-nodes/protocols#defining-a-protocol).
...
### 📘 Learn more
Learn more about [querying protocols](https://developer.tbd.website/docs/web5/decentralized-web-nodes/protocols#protocols-in-practice).
...
### 📘 Learn more
- Learn more about [protocols](https://developer.tbd.website/docs/web5/decentralized-web-nodes/protocols/).
