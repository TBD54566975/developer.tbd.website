...
- Enforce permissions or authorization on records through [protocols](/docs/web5/decentralized-web-nodes/protocols)
...
[Protocols](/docs/web5/decentralized-web-nodes/protocols) help define both the data schema and permissions as it relates to a certain application or use case. It details what objects are stored as part of the application and who has what permissions on these objects.
...
<header className="flex-col text-center mb-4">
    <h1 className="text-2xl font-bold mb-4">Shared Todo</h1>
    <p>Manage a set of todos towards your goals with friends.</p>
    <button v-if="myDID" className="btn" id="copy-did" @click="copyDID">Copy your DID</button>
</header>
```
