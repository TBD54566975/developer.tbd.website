...
## What we will build
Bob and Alice are two friends that love doing things together. They often set collective goals and divide tasks between themselves to reach these goals.
