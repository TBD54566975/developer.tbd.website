...
In the [Build a Todo App](/docs/web5/build/apps/todo-app-tutorial) tutorial, we learned how to build a basic single-user decentralized todo app with `Web5.js` and `Vue.js`.

For this tutorial, we will expand on the core features and build out a more collaborative app that allows multiple users work on the same, shared todo list.
