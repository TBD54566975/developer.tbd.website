...
<a href="https://developer.tbd.website/docs/web5/learn/sync/">Sync intervals</a> occur every two minutes. If you're eager to see immediate updates for testing purposes, you can adjust the sync settings. Update the line:
