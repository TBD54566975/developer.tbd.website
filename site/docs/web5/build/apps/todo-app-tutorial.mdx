...
<div className="grid grid-cols-1 desktop:grid-cols-1">
  <iframe class="aspect-video" src="https://www.youtube.com/embed/jyq7EqlSJ_g?si=nXENay5ypO3HCeXz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
[![Play in CodeSandbox](https://assets.codesandbox.io/github/button-edit-lime.svg)](https://codesandbox.io/p/sandbox/github/TBD54566975/developer.tbd.website/tree/main/examples/tutorials/todo-completed)
...
Congratulations, you've just built a decentralized web app! Feel free to check out the [finished version of the ToDo app here](https://github.com/TBD54566975/developer.tbd.website/tree/main/examples/tutorials/todo-completed) or see it deployed [here](https://unrivaled-crumble-56ce70.netlify.app/).
