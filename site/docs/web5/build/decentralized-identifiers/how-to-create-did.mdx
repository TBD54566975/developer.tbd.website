...
import importDidsKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/web5/build/decentralizedidentifiers/importDidsKt.snippet.kt'
...
<Shnip
  snippets={[
    ...
    { snippetContent: importDidsKt, language: 'Kotlin' },
  ]}
/>
