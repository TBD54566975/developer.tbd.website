...
import createDidIon from '!!raw-loader!@site/snippets/web5/build/decentralized-identifiers/createDidIon.snippet.js'
import kotlinTest from '!!raw-loader!@site/snippets/kotlin/kotlin-test.snippet.kt'
...
<CodeSnippet snippet={createDidIon} />
...
### Kotlin test
<CodeSnippet snippet={kotlinTest} language="kotlin" />
