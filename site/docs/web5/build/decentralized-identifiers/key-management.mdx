...
## Quickstart
Key management is built right into the <LanguageSwitchLink text='DidMethod' links="{'kotlin': 'https://github.com/TBD54566975/web5-kt/blob/301bf54dd3c0d8b310212011e116e22c2894766c/dids/src/main/kotlin/web5/sdk/dids/DidMethod.kt', 'javascript': '#'}"/> implementations provided in the `Web5` SDK, such as `DidDht`. Here is how you'll create or load a DID with a `KeyManager`:

<LanguageSwitchBlock>
    <div language='javascript'>
        {/* Put any text or code snippets specific to JavaScript in here */}
    </div>
    <div language='kotlin'>
        {/* Put any text or code snippets specific to Kotlin in here */}
    </div>
</LanguageSwitchBlock>
