...
DRLs enable direct read access to permussioned data stored in DWNs. To read records from a DWN,  After writing records to a DWN, you can use DRLs (prefixed with `https://dweb`) to fetch the data. 
