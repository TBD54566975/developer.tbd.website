...
Importing your portable DID, gives the identity agent permission to manage data on your behalf. This step links your agent to your unique decentralized identifier (DID).
