...
:::note
Before querying records by protocol path, ensure that the protocol is [installed](https://developer.tbd.website/docs/web5/learn/protocols/#installing-a-protocol). 
:::
