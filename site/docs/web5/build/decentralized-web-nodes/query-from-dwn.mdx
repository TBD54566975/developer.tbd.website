...
The following snippets demonstrate how to query records by path and type to match a defined protocol. The protocol definition below has an audio type and a video type:
