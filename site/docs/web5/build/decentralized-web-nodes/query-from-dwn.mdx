...
The following snippets demonstrate how to query records by protocol path and structure to match a defined protocol. The protocol definition below has an audio structure and a video structure:
