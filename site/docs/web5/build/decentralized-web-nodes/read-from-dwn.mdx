...
However, you may not have the `recordId` available, and instead need to query for records that match a [specific filter](/docs/web5/build/decentralized-web-nodes/query-from-dwn#filterable-record-properties). This will return an array of records:
