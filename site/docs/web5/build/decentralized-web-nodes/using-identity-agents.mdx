...
While the `Web5.connect()` function generates a **new** identity and a local User Agent, Identity Agents allow you to connect a web app to an **existing** identity. This is useful for maintaining a cohesive online presence. 
