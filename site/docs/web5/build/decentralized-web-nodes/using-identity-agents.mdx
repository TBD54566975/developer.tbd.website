...
Next, enable the Identity Agent to manage user DIDs within your application by connecting each DID to a DWN. Below is an example using TBD-hosted DWN endpoints:
