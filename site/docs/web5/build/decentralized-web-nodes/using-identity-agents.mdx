...
To enable the Identity Agent to manage user DIDs within your application, configure each DID to connect to a DWN. Below is an example using TBD-hosted DWN endpoints:
