...
## Create and connect to a DWA
To create a DWA, you need to activate polyfills. Use this [DWA starter app](https://github.com/TBD54566975/dwa-starter) as an example:
