...
Use up to 1GB of free storage on a Community DWN instance hosted by [Google and the Decentralized Identity Foundation (DIF)](https://identity.foundation/dwn/) for non-production environments.
>>>>>>> 310d1a27 (Update community node note)
