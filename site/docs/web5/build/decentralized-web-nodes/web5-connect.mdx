...
## Activate Polyfills
Activate Web5 service worker polyfills to add Decentralized Resource Locators(DRLs) and manage DWN offline syncs. See [DWA starter app](https://github.com/TBD54566975/dwa-starter) for more info.
