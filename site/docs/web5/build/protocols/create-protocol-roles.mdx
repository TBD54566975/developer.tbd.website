...
## Assigning roles
After installing the protocol on the actors' DWNs, assign roles using the records interface. Then, send the record to your DWN and the recipient's DWN. Below is an example of assigning an actor to a guest role by sending the actor a guest object.
