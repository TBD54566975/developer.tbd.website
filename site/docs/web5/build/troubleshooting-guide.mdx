...
Then, in your `next.config.js` file, add the following:
...
When starting up and connecting to the Web5 sdk, some polyfills might be missing. To fix this at the moment, update your Web5 import to
