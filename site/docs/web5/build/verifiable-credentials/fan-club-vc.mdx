...
import fanClubSdkInstallJs from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/web5/build/verifiable-credentials/fanClubSdkInstallJs.snippet.bash'
...
import fanClubSdkInstallGradle from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/web5/build/verifiablecredentials/fanClubSdkInstallGradle.snippet.gradle'
import fanClubSdkInstallPom from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/web5/build/verifiablecredentials/fanClubSdkInstallPom.snippet.xml'
...
<Shnip
   snippets={[
    { snippetContent: fanClubSdkInstallJs, language: 'JavaScript', codeLanguage: 'bash'},
    {
      language: 'Kotlin',
      nestedSnippets:{
          'Gradle': {
            "snippet": fanClubSdkInstallGradle,
            "language": 'kotlin'
          },
          'Maven': {
            "snippet": fanClubSdkInstallPom,
            "language": 'xml'
          }
        }
    }
...
<Shnip
   snippets={[
    { snippetContent: createDids, language: 'JavaScript', title: 'Issuer.js'},
    { snippetContent: createDidsKt, language: 'Kotlin', title: 'Issuer.kt'},
    ]}
/>
