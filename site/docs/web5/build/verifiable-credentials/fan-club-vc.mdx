...
<Shnip
  inlineSnippets={[
    {
      code: `import { VerifiableCredential, VerifiablePresentation, PresentationExchange } from "@web5/credentials";`,
      language: 'JavaScript',
      title: 'Verifier.js'
    },
    {
      ...
      code: `
{
  "vpDataModel": {
    ...
    "id": "urn:uuid:09dd1229-450c-46b2-aebb-c988a3b29ffd",
    "holder": "did:dht:mb7e5azb7m5mcxbjdirnkrhsbttpu8mccs3apywagdms4bii17yo",
    "verifiableCredential": [
