...
import jwtToVcVar from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/web5/build/verifiable-credentials/signedJwt.snippet.js'
...
<Shnip
  snippets={[
    ...
    { snippetContent: jwtToVcVarKt, language: 'Kotlin', title: 'Issuer.kt'},
    ]}
/>
