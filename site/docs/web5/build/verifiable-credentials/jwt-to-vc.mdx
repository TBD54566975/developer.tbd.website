...
import jwtToVcVar from '@site/snippets/testsuite-kotlin/src/test/kotlin/docs/web5/build/verifiablecredentials/getVerifiableCredentialFromJwtJwtDeclaration.snippet.kt'
