...
import jwtToVcVar from '../../../../snippets/testsuite-kotlin/src/test/kotlin/docs/web5/build/verifiablecredentials/getVerifiableCredentialFromJwtJwtDeclaration.snippet'
import jwtToVcParse from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/web5/build/verifiablecredentials/getVerifiableCredentialFromJwtParseJwt.snippet'
