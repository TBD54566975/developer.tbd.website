...
import requiredImportsForPex from '!!raw-loader!@site/snippets/testsuite-javascript/__tests__/web5/build/verifiable-credentials/requiredImportsForPex.snippet.js'
...
import requiredImportsForPexKt from '!!raw-loader!@site/snippets/testsuite-kotlin/src/test/kotlin/docs/web5/build/verifiablecredentials/requiredImportsForPexKt.snippet.kt'
...
<Shnip
   snippets={[
    { snippetContent: requiredImportsForPex, language: 'JavaScript'},
    { snippetContent: requiredImportsForPexKt, language: 'Kotlin'}
    ]}
/>
