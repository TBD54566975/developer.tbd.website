...
<Shnip
   snippets={[
    ...
    { 
      content: 'Bundle your VCs into one presentation by converting your presentation result into a [Verifiable Presentation](/docs/glossary#verifiable-presentation) with the `VerifiablePresentation.create()` method. In this case, the holder is the entity presenting the VP to the lender.',
