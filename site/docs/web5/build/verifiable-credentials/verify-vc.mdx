...
Upon receipt, a Verifiable Presentation is encoded as a [JWT](/docs/web5/build/verifiable-credentials/jwt-to-vc#what-is-a-jwt) and can be verified via the `VerifiableCredentials.verify()` function. 
