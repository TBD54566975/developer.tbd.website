...
Upon receipt, the presentation of the VCs are encoded as [JWTs](/docs/web5/build/verifiable-credentials/jwt-to-vc#what-is-a-jwt) and can be verified via the `VerifiableCredentials.verify()` function. 
...
* **warn** - more credentials were presented than was required
