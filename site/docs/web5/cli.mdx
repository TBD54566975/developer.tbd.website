...
The `web5 did create` command [creates a DID](/docs/web5/decentralized-identifiers/how-to-create-did) using different DID methods such as `did:dht`, `did:jwk`, and `did:web`. 
...
web5 vc create "alice" --portable-did $PORTABLE_DID --expiration-date 2025-12-31
```
