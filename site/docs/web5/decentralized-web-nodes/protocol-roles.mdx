...
You can assign actors with these roles the ability to read, write, query, update, delete, or prune data stored on your [Decentralized Web Node (DWN)](/docs/web5/decentralized-web-nodes/what-are-dwns) as show in the example below:
