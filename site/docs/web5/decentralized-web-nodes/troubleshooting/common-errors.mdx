...
This error occurs when attempting to interact with a DWN that does not have the required protocol installed. To solve this, **ensure both parties have successfully [installed the protocol definition](/docs/web5/decentralized-web-nodes/protocols#installing-a-protocol)**.
