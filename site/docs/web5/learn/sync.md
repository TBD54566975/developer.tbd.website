...
You can change the sync interval by setting it to [any value accepted by ms](https://www.npmjs.com/package/ms), but be mindful of power or data consumption. To disable sync set to 'off'.
