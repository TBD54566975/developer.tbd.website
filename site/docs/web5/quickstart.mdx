...
<QuickstartCodeRunner executeCodeName="executeCreateVc" stepIndex={2} viewJsonObj={true} defaultInputValue="@alicesmith123" customPlaceholder={"Your VC will appear here"}/>
