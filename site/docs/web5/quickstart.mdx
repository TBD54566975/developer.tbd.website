...
import {executeDidCreate, executeGetBearerDid, executeCreateVc, executeSignVc, executeWriteVcToDwn, executeReadVcFromDwn, executeParseVc } from '@site/code-snippets/web5/quickstart.js';
...
This Web5 instance is what you'll use to access the other objects of Web5 such as `dwn`. Within the connect function we’re using `dht` as the DID method. Learn more [DID methods](/docs/web5/learn/decentralized-identifiers#methods).
...
<QuickstartCodeRunner executeCode={executeDidCreate} stepIndex={0} autoOpenDetails={false} customPlaceholder={"Your DID will appear here"} />
...
#### Try it!
<QuickstartCodeRunner executeCode={executeGetBearerDid} stepIndex={1} viewJsonObj={true} collapseLevel={1} customPlaceholder={"Your Bearer DID will appear here"}/>
...
<QuickstartCodeRunner executeCode={executeCreateVc} stepIndex={2} viewJsonObj={true} defaultInputValue="@alicesmith123" customPlaceholder={"Your VC will appear here"}/>
...
<QuickstartCodeRunner executeCode={executeSignVc} stepIndex={3} customPlaceholder={"Your JWT will appear here"}/>


## 5. Store VC in DWN

Your users can now store the JWT form of their VC in a [DWN (Decentralized Web Node)](https://developer.tbd.website/docs/web5/learn/decentralized-web-nodes).
...
#### Try it!
<QuickstartCodeRunner executeCode={executeWriteVcToDwn} stepIndex={4} viewJsonObj={true} collapseLevel={1} customPlaceholder={"Your written result will appear here"}/>
...
<QuickstartCodeRunner executeCode={executeReadVcFromDwn} stepIndex={5} customPlaceholder={"Your read result will appear here"}/>
...
<QuickstartCodeRunner executeCode={executeParseVc} stepIndex={6} viewJsonObj={true} customPlaceholder={"Your parsed VC will appear here"} />
