...
<Shnip
   snippets={[
    { snippetName: 'fanClubVcImportsJs', language: 'JavaScript', title: 'Issuer.js'},
    { snippetName: 'fanClubVcImportsKt', language: 'Kotlin', title: 'Issuer.kt'},
    ]}
/>
...
### Create DIDs
As a prerequisite, both the Fan Club and Alice need [decentralized identitifiers](/docs/web5/decentralized-identifiers/what-are-dids).
