...
** Note: **
Your code snippet should be within a function block. The function block is how we name the code snippet, we only display what's in the body of the function block.
...
It's important to make your function name as specific as possible, because it me used to reference the code snippet in the code-snippets.json file. Similar names will overwrite one another.
...
2. The second update you'll make would be on the content page itself. Where you wanted the code snippet to exist at `api/web5-js/protocols.md`, you'd add the following:
...
3. The 3rd step from here is to write tests for the code snippet.
