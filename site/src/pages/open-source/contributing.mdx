...
To use the snippet in your documentation(`.mdx` file), you're going to use the `Shnip` component, and import the code snippet from `!!raw-loader!` in the following format:
