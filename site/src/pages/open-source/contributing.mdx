...
- **Spread the Word:** Help us reach more people by sharing [TBD's projects](https://github.com/TBD54566975), [website](https://developer.tbd.website/docs/), and/or [X(fka Twitter)](https://twitter.com/TBDDev).
...
<a href="https://discord.com/events/937858703112155166/1154126364484583465">
  <img
    style={{ height: '446px' }}
    src="https://hackmd.io/_uploads/Bk2Mr77xT.png"
  />
</a>
<a href="https://discord.com/events/937858703112155166/1154132976519618591">
  <img
    style={{ height: '446px' }}
    src="https://hackmd.io/_uploads/ByU7rm7x6.png"
  />
</a>
...
The file path should match the same path as both code snippet and the actual content:

`__tests__/code-snippets/api/web5-js/protocols.test.js` would be the path for the protocols example above.

```js
import { test, beforeAll, expect, describe } from 'vitest';
import { Web5 } from '@web5/api/browser';
// import your functions from your codesnippet file
import {
  queryMusicProtocol,
  queryProtocolDescending,
  configureProtocolWithDefinition
  } from '../../../code-snippets/api/web5-js/protocols'
