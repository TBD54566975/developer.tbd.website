...
## TBD Tech Talks
<p style={{ fontSize: '19px' }}> Swing by the TBD booth (Hall 2.2, Booth 2_40) and learn about Web5, tbDEX, DIDs, VCs, and more!</p>
...
**HINT:** Follow our [Twitter](https://twitter.com/TBDevs) for clues to where we are!
