...
This error occurs when you attempt to sign a verifiable credential using the String version of a DID. To resolve this, sign with a [Portable DID](/docs/web5/decentralized-identifiers/how-to-create-did#portable-did) so that your private key is used to cryptographically sign the credential.
