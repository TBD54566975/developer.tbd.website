...
- [tbDEX Spec](/components/tbdex-protocol/lib/README)

- [PFI Example Implementation](/components/tbdex-protocol/pfi-mock-impl/README)

- [Decentralized Web Nodes](/components/dwn-sdk-js/README)

- [Decentralized Identifiers](https://identity.foundation/ion/)

- [Self-Sovereign Identity Service](/components/ssi-service/README)

- [Self-Sovereign Identity SDK](/components/ssi-sdk/README)
