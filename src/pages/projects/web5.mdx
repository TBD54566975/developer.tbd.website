...
<div className="inline-flex space-x-20 pt-8">
<div className="py-8">
  <Button label="Getting Started" url="https://github.com/TBD54566975/collaboration/blob/main/projects/GETTING_STARTED_DWP.md" />
</div>
<div className="py-8">
  <Button label="User Chat" url="https://discord.com/channels/937858703112155166/969272658501976117" />
</div>
</div>
<Divider type="slash" />
